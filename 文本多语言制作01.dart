      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(Localizations.of(context, Zifu).t("a")),
            Text(Localizations.of(context, Zifu).t("b")),
            Text(Localizations.of(context, Zifu).t("c")),
            Text(Localizations.of(context, Zifu).t("d")),
            Text(Localizations.of(context, Zifu).t("e")),
          ],
        ),
      ),
